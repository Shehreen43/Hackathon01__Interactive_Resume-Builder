...
(_d = document.getElementById("resumeBuilder")) === null || _d === void 0 ? void 0 : _d.addEventListener("submit", function (event) {
    ...
    `;
            ...
            // const resumeName = (document.getElementById("userName") as HTMLInputElement)?.value;
            ...
            // const shareButton = document.getElementById("shareLink") as HTMLElement;
            // shareButton.addEventListener("click", () => {
            //     navigator.clipboard.writeText(resumeUrl).then(() => {
            //         const shareMessage = document.getElementById("shareMessage") as HTMLElement;
            //         shareMessage.textContent = "Resume link copied!";
            //         shareMessage.classList.remove("hidden");
            //         setTimeout(() => shareMessage.classList.add("hidden"), 3000); // Hide after 3 seconds
            //     });
            // });
            // const downloadButton = document.getElementById("downloadPDF") as HTMLElement;
            // downloadButton.addEventListener("click", function () {
            //     const resumeElement = document.getElementById("resumeOutput") as HTMLElement;
