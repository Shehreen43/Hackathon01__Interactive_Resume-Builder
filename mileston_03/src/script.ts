// Selecting elements
const toggleSkills: HTMLElement | null = document.getElementById("toggle-skills") as HTMLInputElement;
const skills: HTMLElement | null = document.getElementById("skills") as HTMLElement;

// Select the profile picture and file input elements
const resumeProfilePicture = document.getElementById("profilePicture") as HTMLImageElement | null;
const resumeProfilePictureInput = document.querySelector("input[type=file]") as HTMLInputElement | null;
